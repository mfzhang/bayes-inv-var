...
fprintf('\n');
for i = 1 : L
  [Perf(i,1), Perf(i,2), Perf(i,3), Perf(i,4) ] = evaluateBenchmark(DATADIR, benchmarks{i});
...
%% Single benchmark
function [meanSMSE stdSMSE meanMLL stdMLL] = evaluateBenchmark(DATADIR, benchmark)
